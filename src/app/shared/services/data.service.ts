...
export class DataService {
  ...
  public getTopRatedMediaChanges(mediaType: MediaType): Observable<MediaResp> {
    ...
    return this.http.get<MediaResp>(`${this.baseUrl}/${mediaType}/top_rated`, { headers: this.headers, params });
  }

  public getHundredTopRatedMedia(mediaType: MediaType,pagesToLoad: number = 5): Observable<MediaResp>{
